...
from model.building_blocks.DenseBlock import DenseBlock
from model.building_blocks.TransitionBlock import TransitionBlock
from model.building_blocks.UpsamplingBlock import UpsamplingBlock
...
class DenseUNet3d(nn.Module):
    def __init__(self):
        ...
        self.dense1 = DenseBlock(96, 32)
        self.dense2 = DenseBlock(32, 32)
        self.dense3 = DenseBlock(32, 32)
        self.dense4 = DenseBlock(32, 32)
